...
def mostrar_ranking(pantalla, ranking):
    ...
    btn_menu = pygame.Rect(WIDTH - 200, HEIGHT - 80, 150, 40)  # 🔥 Nuevo botón "Volver al menú"
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                elif btn_menu.collidepoint(mouse_pos):  # 🔥 Volver al menú
                    return  
